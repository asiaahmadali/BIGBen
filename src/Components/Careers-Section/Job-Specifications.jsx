function JobSpecifications(Props) {
  return (
    <div className="p-4 md:p-8 border-b-[2px] overflow-hidden">
      <h1 className="text-2xl lg:text-4xl font-bold mb-4 text-center lg:mt-[100px] mt-[10px]">
        {Props.title}
      </h1>
      <p className="text-base lg:text-lg mb-6">{Props.description}</p>
      ...
      <h2 className="text-xl lg:text-2xl font-semibold mb-2">What We Offer</h2>
