    ...
    <>
      <div className="mb-[50px] mt-[50px] overflow-hidden">
        <div className="mt-[20px] mb-[20px]">
          <h1
            className="font-bold lg:text-5xl text-2xl text-center"
            data-aos="fade-right"
          >
            Values
          </h1>
        ...
        <div className="flex lg:flex-row flex-col justify-around items-center lg:items-start mt-[30px]">
          <div>
            <img src="images/value.webp" alt="value" data-aos="fade-right" />
          </div>

          <div className="lg:w-[45%] w-[90%] flex flex-col gap-[40px]">
            <div
